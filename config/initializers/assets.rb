...
Rails.application.config.assets.precompile += %w( users/talking.scss )
...
Rails.application.config.assets.precompile += %w( lyrics/new.scss )
Rails.application.config.assets.precompile += %w( lyrics/show.scss )
Rails.application.config.assets.precompile += %w( talkroom/show.scss )